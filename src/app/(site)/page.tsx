...
const services = [
  {
    ...
    desc: "จำหน่ายกล้องวงจรปิดคมชัดหลากหลายรุ่น ดูผ่านมือถือได้ พร้อมรับประกันสินค้า",
  },
  {
    icon: "🌐",
    title: "อุปกรณ์อินเทอร์เน็ต",
    desc: "จำหน่ายอุปกรณ์เครือข่ายและอินเทอร์เน็ต สำหรับบ้านและร้านค้า สินค้าคุณภาพ",
  },
  {
    icon: "🛡️",
    title: "บริการหลังการขาย",
    desc: "รับเคลมและดูแลการรับประกันสินค้าตามหมายเลขซีเรียล อุ่นใจตลอดการใช้งาน",
  },
];
    ...
    <main>
      ...
      <section className="bg-gradient-to-b from-indigo-50 to-white">
        <div className="mx-auto max-w-6xl px-4 py-20 text-center md:px-8 md:py-28">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base text-slate-600">
            ร้านจำหน่ายกล้องวงจรปิดและอุปกรณ์อินเทอร์เน็ตหลากหลายรุ่น
      ...
      <section id="services" className="mx-auto max-w-6xl px-4 py-16 md:px-8">
        ...
        <p className="mt-2 text-center text-sm text-slate-500">
          ดูแลครบตั้งแต่เลือกสินค้า จนถึงบริการหลังการขาย
        </p>
      ...
      <section className="bg-slate-900">
        <div className="mx-auto max-w-6xl px-4 py-14 text-center md:px-8">
          <h2 className="text-2xl font-bold text-white">
            กำลังมองหากล้องวงจรปิดหรืออุปกรณ์อินเทอร์เน็ต?
          </h2>
